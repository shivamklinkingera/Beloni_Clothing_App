    ...
    >
      ...
      >
        <Svg width={40} height={40} fill='none'>
          <Path
            ...
            fill={ratingValue >= 1 ? '#FFBE00' : 'white'}
          />
        </Svg>
      </TouchableOpacity>
      <TouchableOpacity
      ...
      >
        <Svg width={40} height={40} fill='none'>
          <Path
            d='m20 3.333 5.15 10.434 11.517 1.683-8.334 8.117L30.3 35.033 20 29.617 9.7 35.033l1.967-11.466-8.334-8.117 11.517-1.683L20 3.333Z'
            fill={ratingValue >= 2 ? '#FFBE00' : 'white'}
          />
        </Svg>
      </TouchableOpacity>
      <TouchableOpacity
      ...
      >
        <Svg width={40} height={40} fill='none'>
          <Path
            d='m20 3.333 5.15 10.434 11.517 1.683-8.334 8.117L30.3 35.033 20 29.617 9.7 35.033l1.967-11.466-8.334-8.117 11.517-1.683L20 3.333Z'
            fill={ratingValue >= 3 ? '#FFBE00' : 'white'}
          />
        </Svg>
      </TouchableOpacity>
      <TouchableOpacity
      ...
      >
        <Svg width={40} height={40} fill='none'>
          <Path
            d='m20 3.333 5.15 10.434 11.517 1.683-8.334 8.117L30.3 35.033 20 29.617 9.7 35.033l1.967-11.466-8.334-8.117 11.517-1.683L20 3.333Z'
            fill={ratingValue >= 4 ? '#FFBE00' : 'white'}
          />
        </Svg>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => setRatingValue(5)}>
        <Svg width={40} height={40} fill='none'>
          <Path
            d='m20 3.333 5.15 10.434 11.517 1.683-8.334 8.117L30.3 35.033 20 29.617 9.7 35.033l1.967-11.466-8.334-8.117 11.517-1.683L20 3.333Z'
            fill={ratingValue >= 5 ? '#FFBE00' : 'white'}
          />
        </Svg>
      </TouchableOpacity>
    </View>
